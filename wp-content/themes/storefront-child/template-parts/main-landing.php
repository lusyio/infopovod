...
<div class="explosive">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="explosive__header">Взрывной PR дает <br> <span>5 РАЗРЫВНЫХ</span> результатов</p>
            </div>
            <div class="col-12 col-lg-8 offset-0 offset-lg-2">
                <ol>
...
<div class="presentation">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="presentation__header">То, <span>что вы видите по новостям</span> сегодня - <br> <span>результат нашей работы</span>
                    вчера
                </p>
                <div class="row">
                    <div class="col-12 col-lg-8 offset-0 offset-lg-2">
                ...
                <div class="row presentation__card">
                    ...
                    <div class="col-12 col-lg-5 pr-lg-5 pr-unset m-auto">
                        <p>Посмотрите <strong>презентацию компании</strong>, чтобы получить полное представление о
                            ее
                            деятельности</p>
                        <a href="/wp-content/themes/storefront-child/docs/Pr-agentstvo-infopovod.pdf" download
...
<div class="howItWorks">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="howItWorks__header">Как это работает</p>
            </div>
